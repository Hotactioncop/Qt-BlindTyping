...
QT_MOC_LITERAL(6, 55, 9), // "sendScore"
QT_MOC_LITERAL(7, 65, 9), // "startGame"
QT_MOC_LITERAL(8, 75, 9) // "nextLevel"

    },
    "Keyboard\0sendWord\0\0sendSignal\0correctChar\0"
    "sendProgress\0sendScore\0startGame\0"
    "nextLevel"
};
...
void Keyboard::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 4: _t->sendScore((*reinterpret_cast< int(*)>(_a[1]))); break;
        ...
        {
            using _t = void (Keyboard::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Keyboard::sendScore)) {
                *result = 4;
                return;
            }
        }
...
// SIGNAL 4
void Keyboard::sendScore(int _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
